    ...
    extends AbstractMojo
{
    ...
    /**
     * Specifies whether to verify omod contents against the contents of the config file.
     * 
        ...
        throws MojoExecutionException, MojoFailureException
    {
        if ( verifyOmod )
        {
            ...
            {
                String servletFileName = classToFilename( servletDoms[s].getChild( "servlet-class" ).getValue() );
